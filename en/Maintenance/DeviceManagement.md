...
### Add a single LoRaWAN device document 
...
### Bulk import of LoRaWAN devices 
For large-scale deployment scenarios, you can import LoRaWAN device files in batches through Excel tables. 

1. Download the standard template file (refer to the sample format <font style="color:rgba(0, 0, 0, 0.88);">: </font>[mt_sdev_pf_macs--1756347416255.xlsx](https://mensikeji.yuque.com/attachments/yuque/0/2025/xlsx/45351741/1758943470779-38316891-32b2-431b-b89a-3d9c708e9398.xlsx)); 
...
## Device Details Page Function Module 
...
### Asset Class Model Example: Multi-device Temperature and Humidity Average Calculation 
