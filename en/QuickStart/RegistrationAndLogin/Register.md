...
2. The system will automatically send an email containing the verification code to the mailbox. 
3. Fill in the received verification code in the page to verify the ownership of the mailbox. 
4. After the verification is successful, the first login needs to complete the basic information, including: 
    - nickname 
    - user account (unique in the system) 
    - login Password 

after completing the above information, the registration process will be completed. 
...
users can choose any way to log in according to the actual situation.
