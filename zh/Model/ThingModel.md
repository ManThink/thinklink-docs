...
- **【注意2】配置生效方式**: 修改完 Home Assistant 的字段配置后，需前往TKL的**服务器配置页面**，点击**“重新注册所有设备”** 按钮，更新后的字段配置才会生效，并触发设备信息向 Home Assistant 的重新发布。
...
### 1.5.2. 支持的设备类型
当前，ThinkLink V2 只原生支持将设备作为**sensor**（传感器）类型接入 Home Assistant 。
