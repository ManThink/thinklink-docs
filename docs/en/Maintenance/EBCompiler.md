...
EB (EdgeBus) is a virtual machine running on low-power MCUs. EB enables complex sensor integration through programming with TypeScript. For a detailed introduction to EB, please refer to [EB compiler SDK instructions](../EB/EdgeBusCompiler.md)
