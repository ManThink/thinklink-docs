...
- ✅ **swVersion**: Should match the EB firmware version. It is recommended to use **[MT ACT] action -> app para read RPC** to obtain the accurate value
...
- ✅ **swPeriod**: Default is `8000ms` (used in debug mode), or retrieve via [MT ACT] action -> cf para read**
...
### 1.2.3. View Upgrade Status and Tasks
